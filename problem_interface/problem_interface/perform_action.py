...
class PerformAction():
    def __init__(self):
        ...
        self._action_client = ActionClient(
            self.node, ExecuteTaskAction, ACTION_NAME)
    ...
    def do_action(self, command: ACTIONS, target: str) -> None:
        ...
        available commands: 'pick', 'place', 'navigate'
    ...
    def done_callback(self, future):
        try:
            ...
            self.node.get_logger().info(f'Action finished with result {result} and status {status}')
